...
const Filter = ({ column, filterVariant = null, label, onChange }) => {
  ...
  const renderMenuItems = () => sortedUniqueValues.map(key => (<Item key={key}>{capitalizeFirstLetter(key)}</Item>))
    ...
    filterVariant === "select"
      ? (<MenuTrigger>
        ...
        <Menu
          ...
          selectedKeys={column.getFilterValue() ? new Set([column.getFilterValue()]) : new Set([])}
